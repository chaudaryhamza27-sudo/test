...
export const LEGAL_PAGES = {
  terms: {
    ...
    icon: "document",
    blocks: [
      { type: "callout", tone: "info", text: "PK92 is a free educational simulation. All balances are demo credits with no monetary value. Nothing on this platform involves real money, real wagering, or a real gambling license." },
      { type: "h", text: "1. What PK92 is" },
      { type: "p", text: "PK92 is a demonstration application built to show how a crash-style prediction game, wallet, and account system could work in an interactive UI. Every account starts with a simulated credit balance, and every deposit, withdrawal, bet, and payout uses those same simulated credits. No real currency ever enters or leaves the platform through normal use of the product." },
      ...
      { type: "h", text: "4. Demo credits" },
      { type: "p", text: "Demo credits shown in your wallet, in deposit/withdrawal history, and in game results have no cash value, cannot be redeemed for money or goods, and cannot be transferred outside the platform. Any \"deposit\" or \"withdrawal\" flow you complete — including through third-party test/sandbox payment pages — is a simulated transaction for demonstration purposes only." },
      ...
      { type: "p", text: "Because this is a demonstration product, features, content, and these terms may change at any time without prior notice." },
  ...
  privacy: {
    ...
    icon: "shield",
    blocks: [
      { type: "callout", tone: "info", text: "This is a demo application. Use a name, email, or phone number you're comfortable putting into a test product — avoid submitting sensitive personal or financial information." },
      { type: "h", text: "1. What we collect" },
      { type: "p", text: "To create and operate a demo account, we store the information you provide at signup (name, phone number and/or email, and a hashed password), plus records the platform generates as you use it: your simulated wallet balance, transaction history (demo deposits/withdrawals/bets), notifications, and basic activity logs (e.g. login timestamps, IP address at time of request) used for account security and abuse prevention." },
      ...
      { type: "p", text: "Account data is used only to operate the demo: authenticating you, displaying your simulated balance and history, sending in-app notifications, and maintaining basic security logs. We do not sell your data or share it with third parties for marketing." },
      ...
      { type: "p", text: "Because this is a demo environment, account and activity data may be periodically reset or deleted without notice. If you'd like your account data removed sooner, contact us through the Contact/Support page." },
      { type: "h", text: "7. Changes" },
      { type: "p", text: "This policy may be updated as the demo evolves. Continued use of the platform after a change means you accept the updated policy." },
    ],
  },
  ...
  "responsible-gaming": {
    ...
    icon: "shield",
    blocks: [
      { type: "callout", tone: "warning", text: "PK92 uses demo credits with no real value — you cannot lose real money here. This page exists because the interface is modeled on real-money gambling products, and we want to be upfront about the behaviors those products can encourage." },
      ...
      { type: "h", text: "3. Good habits, even in a demo" },
      { type: "ul", items: [
  ...
  "betting-rules": {
    ...
    icon: "document",
    blocks: [
      { type: "callout", tone: "info", text: "These rules describe how the simulated Aviator-style crash game works. All amounts are demo credits." },
      { type: "h", text: "1. How a round works" },
      { type: "p", text: "Each round starts a multiplier at 1.00x that climbs over time. At an unpredictable point, the round \"crashes\" and the multiplier stops. Players place a bet (a demo-credit stake) before the round starts, and can cash out any time while the multiplier is climbing." },
      { type: "h", text: "2. Placing a bet" },
      { type: "p", text: "You may place a bet only during the betting window before a round starts, using demo credits already in your wallet. Bets are deducted from your balance immediately and are final once the round begins — bets cannot be cancelled after the round starts." },
      { type: "h", text: "3. Cashing out" },
      { type: "p", text: "If you cash out before the round crashes, your payout is your stake multiplied by the multiplier value at the moment you cashed out, credited to your demo wallet immediately. If the round crashes before you cash out, your stake for that round is lost." },
      ...
      { type: "p", text: "Because all amounts are demo credits with no cash value, there is no real-money payout to dispute. If you believe a round result was recorded incorrectly, contact us through the Contact/Support page." },
    ],
  },
  ...
  "deposit-policy": {
    ...
    blocks: [
      ...
      { type: "p", text: "When you submit a deposit request, the amount is added to your demo wallet balance as a simulated transaction. Where a real payment provider's checkout page is shown (in test/sandbox mode), completing it does not move real funds — it only demonstrates the integration." },
      { type: "h", text: "2. Minimum amount" },
      { type: "p", text: "A minimum deposit amount applies for demonstration purposes (shown on the Deposit page) and exists to mirror how a real platform enforces minimums, not because of any real processing cost." },
      ...
      { type: "p", text: "Do not enter real card numbers, real bank credentials, or other sensitive real-world payment details anywhere in this demo, even on a linked sandbox checkout page." },
    ],
  },
  ...
  "withdrawal-policy": {
    ...
    blocks: [
      ...
      { type: "p", text: "A withdrawal request deducts demo credits from your wallet balance and creates a Pending transaction record, mirroring the shape of a real withdrawal flow. No real transfer to any bank account, mobile wallet, or card occurs at any point." },
      { type: "h", text: "2. Minimum amount and balance checks" },
      { type: "p", text: "A minimum withdrawal amount applies (shown on the Withdraw page). Your requested amount is checked against your current demo balance before the request is accepted, and funds are held (deducted) at request time so you can't submit more than you have." },
      { type: "h", text: "3. Approval and status" },
      { type: "p", text: "Withdrawal requests are reviewed and marked Approved or Rejected. A rejected withdrawal returns the held demo credits to your wallet balance." },
  ...
  "refund-policy": {
    ...
    icon: "document",
    blocks: [
      { type: "callout", tone: "info", text: "Because no real money is ever collected, there is nothing to refund in the traditional sense — this page explains how corrections work for demo credits instead." },
      { type: "h", text: "1. No real-money refunds" },
      { type: "p", text: "Since deposits and withdrawals only ever move simulated demo credits, there is no real payment to reverse or refund." },
      { type: "h", text: "2. Cancelling a pending request" },
      { type: "p", text: "A deposit or withdrawal request that is still Pending has not yet affected your final balance state in a way that can't be corrected — contact Support if you'd like a pending demo request reviewed or reversed." },
      { type: "h", text: "3. Incorrect balances" },
      { type: "p", text: "If you believe your demo wallet balance, transaction history, or game history is incorrect due to a bug rather than the normal outcome of play, contact us through the Contact/Support page and describe what you expected to see." },
    ],
  },
  ...
  contact: {
    ...
    icon: "shield",
    blocks: [
      { type: "callout", tone: "info", text: "This is a demo product without a live support team. The channels below describe how support is represented in the interface." },
      ...
      { type: "p", text: "If you notice a bug — an incorrect balance, a broken flow, or unexpected behavior — the most useful thing you can do in a demo like this is note what you did right before it happened and report it to whoever is maintaining this project." },
