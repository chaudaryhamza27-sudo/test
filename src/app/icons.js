...
// The reference site's "waiting for next round" flight-path mark — a plane
// weaving across a circular route, filled with currentColor so it can be
// recolored/animated per theme like every other icon here.
export const IconFlightPath = (props) => (
...
export const IconWhatsapp = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M12.02 2C6.5 2 2.04 6.46 2.04 12c0 1.77.46 3.45 1.35 4.95L2 22l5.2-1.37a9.9 9.9 0 0 0 4.82 1.23h.01c5.52 0 9.98-4.46 9.98-9.98C22 6.46 17.54 2 12.02 2Zm5.85 14.1c-.25.7-1.44 1.34-1.98 1.4-.5.06-1.13.09-1.83-.12-.42-.13-.96-.3-1.65-.6-2.9-1.25-4.8-4.16-4.94-4.35-.14-.19-1.18-1.57-1.18-3 0-1.42.75-2.12 1.02-2.41.27-.29.58-.36.77-.36.19 0 .39 0 .55.01.18.01.42-.07.66.5.25.6.85 2.07.92 2.22.07.15.12.32.02.51-.1.19-.15.3-.3.47-.15.17-.31.37-.44.5-.15.15-.3.31-.13.6.17.29.75 1.24 1.62 2.01 1.11.99 2.05 1.3 2.34 1.45.29.15.46.13.63-.05.17-.19.72-.84.91-1.13.19-.29.38-.24.63-.14.25.1 1.62.76 1.9.9.28.14.46.21.53.33.07.12.07.7-.18 1.4Z" />
  </svg>
);
